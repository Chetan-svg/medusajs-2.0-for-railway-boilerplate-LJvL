const testimonials = [
  {
    name: "Rajesh Kumar",
    company: "Tata Steel Plant, Jamshedpur",
    rating: 5,
  ...
  {
    name: "Priya Sharma",
    company: "Mahindra Automation Solutions",
    rating: 5,
  ...
  },
  {
    ...
    rating: 5,
    text: "We run multiple manufacturing units across India. ShopEnGenie's same-day dispatch has prevented costly downtime more times than I can count. Genuine parts with full warranty.",
    verified: true,
  },
  {
    name: "Sunita Patel",
