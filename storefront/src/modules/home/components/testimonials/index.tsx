const testimonials = [
  {
    ...
    company: "Richardson Manufacturing",
    rating: 5,
    text: "ShopEnGenie has completely streamlined our procurement process. We've cut our PLC replacement time in half and their technical support actually understands industrial automation.",
    verified: true,
  },
  {
    name: "Sarah Martinez",
    company: "Martinez Automation Solutions",
    rating: 5,
  ...
  {
    name: "David Thompson",
    company: "Thompson Industrial Systems",
    rating: 5,
    text: "We run three manufacturing plants across the Midwest. ShopEnGenie's same-day dispatch has prevented costly downtime more times than I can count. Their genuine parts give us complete confidence.",
    verified: true,
  },
  {
    name: "Jennifer Wilson",
    company: "Wilson Engineering Corp",
    rating: 5,
    text: "From VFDs to I/O modules to HMIs - ShopEnGenie has everything we need for our industrial control systems. One vendor, consistent quality, zero headaches.",
    verified: true,
  },
]
