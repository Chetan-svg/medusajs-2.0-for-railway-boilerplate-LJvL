      ...
      <div className="content-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {valueProps.map((prop, index) => (
            <div
              key={index}
              className="group bg-white border border-gray-200 p-8 hover:border-slate-300 transition-all duration-300"
            >
              <div className="w-12 h-12 bg-slate-100 group-hover:bg-slate-900 flex items-center justify-center mb-6 transition-all duration-300">
