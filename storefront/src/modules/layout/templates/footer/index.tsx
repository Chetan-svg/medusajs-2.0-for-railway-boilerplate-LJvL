        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-6">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            ...
            <div className="mt-6 flex items-center gap-4">
              <a href="mailto:sales@shopengenie.com" className="text-slate-400 hover:text-amber-500 transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </a>
              <a href="tel:+919876543210" className="text-slate-400 hover:text-amber-500 transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col gap-y-3">
            ...
            <ul className="flex flex-col gap-2">
              <li>
                <LocalizedClientLink href="/request-quote" className="text-sm text-slate-400 hover:text-amber-500 transition-colors">
                  Request for Quote
                </LocalizedClientLink>
              </li>
              <li>
                <LocalizedClientLink href="/bulk-orders" className="text-sm text-slate-400 hover:text-amber-500 transition-colors">
                  Bulk Orders
                </LocalizedClientLink>
              </li>
              <li>
                <LocalizedClientLink href="/credit-application" className="text-sm text-slate-400 hover:text-amber-500 transition-colors">
                  Credit Application
                </LocalizedClientLink>
              </li>
              <li>
                <LocalizedClientLink href="/technical-support" className="text-sm text-slate-400 hover:text-amber-500 transition-colors">
                  Technical Support
                </LocalizedClientLink>
              </li>
              <li>
                <LocalizedClientLink href="/shipping" className="text-sm text-slate-400 hover:text-amber-500 transition-colors">
                  Shipping & Delivery
                </LocalizedClientLink>
              </li>
            </ul>
